  ...
  return (
    <section className="py-8 sm:py-12 space-y-4">
      ...
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-4">
        {/* Text section */}
        <div className="text-start space-y-8 flex flex-col justify-center">
          <h1 className="text-primary text-4xl font-bold">Barcode Labels</h1>
          ...
          <div className="text-white space-y-6 text-lg md:text-2xl flex flex-col pt-7">
            {[
