      ...
      <div className="container grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        {data.map((item) => (
          <a
            ...
            className="flex flex-col space-y-4 sm:space-y-5 md:text-start shadow-lg rounded-xl border-[0.5px] border-transparent bg-white hover:bg-primary group duration-300 p-6 transition-transform hover:scale-[1.02]"
          >
            ...
            <p className="text-lg md:text-2xl text-secondary group-hover:text-white duration-300">
              {item.text}
            </p>
          </a>
        ))}
